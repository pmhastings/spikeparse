...
txrx.write_memory(0, 0, 1879048440, application_data_file_reader, 127668)
...
txrx.write_memory(0, 0, 1879200112, application_data_file_reader, 225360)
txrx.write_memory(0, 0, 3842012912, 1879200112)
application_data_file_reader = SpinnmanFileDataReader("192.168.240.1_appData_0_0_6.dat")
txrx.write_memory(0, 0, 1879449476, application_data_file_reader, 124)
txrx.write_memory(0, 0, 3842012016, 1879449476)
application_data_file_reader = SpinnmanFileDataReader("192.168.240.1_appData_0_0_8.dat")
txrx.write_memory(0, 0, 1879449600, application_data_file_reader, 124)
txrx.write_memory(0, 0, 3842012272, 1879449600)
application_data_file_reader = SpinnmanFileDataReader("192.168.240.1_appData_0_0_1.dat")
txrx.write_memory(0, 0, 1879449724, application_data_file_reader, 128)
txrx.write_memory(0, 0, 3842011376, 1879449724)
application_data_file_reader = SpinnmanFileDataReader("192.168.240.1_appData_0_0_12.dat")
txrx.write_memory(0, 0, 1879449852, application_data_file_reader, 124)
txrx.write_memory(0, 0, 3842012784, 1879449852)
application_data_file_reader = SpinnmanFileDataReader("192.168.240.1_appData_0_0_5.dat")
txrx.write_memory(0, 0, 1879449976, application_data_file_reader, 124)
txrx.write_memory(0, 0, 3842011888, 1879449976)
application_data_file_reader = SpinnmanFileDataReader("192.168.240.1_appData_0_0_11.dat")
txrx.write_memory(0, 0, 1879450100, application_data_file_reader, 124)
txrx.write_memory(0, 0, 3842012656, 1879450100)
application_data_file_reader = SpinnmanFileDataReader("192.168.240.1_appData_0_0_4.dat")
txrx.write_memory(0, 0, 1879450224, application_data_file_reader, 124)
txrx.write_memory(0, 0, 3842011760, 1879450224)
application_data_file_reader = SpinnmanFileDataReader("192.168.240.1_appData_0_0_10.dat")
txrx.write_memory(0, 0, 1879450348, application_data_file_reader, 124)
txrx.write_memory(0, 0, 3842012528, 1879450348)
application_data_file_reader = SpinnmanFileDataReader("192.168.240.1_appData_0_0_3.dat")
txrx.write_memory(0, 0, 1879450472, application_data_file_reader, 85888)
txrx.write_memory(0, 0, 3842011632, 1879450472)
